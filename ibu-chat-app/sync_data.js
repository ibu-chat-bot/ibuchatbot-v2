...
// dotenv Next.js'in .env.local dosyasını varsayılan olarak okumayabilir. 
// Bu yüzden manuel olarak .env.local dosyasını da yüklüyoruz.
...
async function syncData() {
  ...
  try {
    ...
    if (process.env.GDRIVE_FILE_ID) {
      ...
      console.log('ℹ️ GDRIVE_FILE_ID bulunamadı, yerel qa_data.txt kullanılıyor...')
